...
@section('content')
    ...
    <nav class="orderstatus container">
        <ul class="d-flex flex-wrap justify-content-evenly p-3">
            <li><a href="/customer/orders" style="color: #ce1212;">All</a></li>
            <li><a href="/customer/orders/pending">Pending</a></li>
            <li><a href="/customer/orders/to-ship">To Ship</a></li>
            <li><a href="/customer/orders/received">Received</a></li>
        ...
        @else
            @foreach($orders as $order)
                <div class="border mb-4">
                    ...
                    @endforeach
                    <div class="d-flex justify-content-between mx-5 pt-2">
                        <p>Status: <strong>{{ $order->status == 'shipped' ? 'to ship' : $order->status }}</strong></p>
                        <div>
